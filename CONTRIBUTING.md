...
The scope is taken from this table rather than invented, and a commit
...
A change to the pipeline, the governance files or the workspace root
carries no scope. It belongs to none of them, and inventing one would
file it under a component whose release it has nothing to do with.
